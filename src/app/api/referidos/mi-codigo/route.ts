...
// logueado (2026-09, programa de referidos). Espejo del mismo endpoint en
// Panel Admin (panel-admin/src/app/api/referidos/mi-codigo) — los repos no
// comparten código, así que esto se mantiene duplicado a mano en los dos
// lados, mismo criterio que PLACEHOLDER_TENANT_NAME y otros duplicados
// existentes entre gounuri-web y Panel Admin.
