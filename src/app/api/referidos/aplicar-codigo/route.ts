// POST /api/referidos/aplicar-codigo — espejo del mismo endpoint en Panel
// Admin (panel-admin/src/app/api/referidos/aplicar-codigo) — ver ese
// archivo para el razonamiento completo. Permite cargar un código de
// invitación DESPUÉS del registro, desde la pantalla de pago
// (PlanSelector.tsx) justo antes de suscribirse.
